...
if __name__ == '__main__':
    ...
    vec_env = make_vec_env(lambda: env.BaseEnv("scenarios/deathmatch.cfg", allowed_actions=allowed_actions, frame_buffer_size=4), 2)
    ...
    callback = SaveModelCallBack(freq=2500, log_dir="logs/progress_log", path="deathmatch_models")
