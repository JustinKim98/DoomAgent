...
if __name__ == "__main__":
    ...
    # model = PPO.load("downloaded_models/deathmatch/model_iter_122500.zip", env=env)
    ...
    # vec_env = make_vec_env(lambda: env.BaseEnv("scenarios/defend_the_center.cfg", allowed_actions, frame_buffer_size=4, living_reward=-1), 2)
    # policy_kwargs = dict(
